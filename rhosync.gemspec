...
Gem::Specification.new do |s|
  ...
  s.files = [
    "CHANGELOG",
     ...
     "spec/app_spec.rb",
     "spec/rhotestapp/Rakefile",
     "spec/rhotestapp/application.rb",
     "spec/rhotestapp/config.ru",
     "spec/rhotestapp/settings/settings.yml",
     "spec/rhotestapp/sources/base_adapter.rb",
     "spec/rhotestapp/sources/sample_adapter.rb",
     "spec/rhotestapp/sources/simple_adapter.rb",
     "spec/rhotestapp/sources/sub_adapter.rb",
     "spec/rhotestapp/vendor/mygem-0.1.0/lib/mygem.rb",
     "spec/rhotestapp/vendor/mygem-0.1.0/lib/mygem/mygem.rb",
