...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/rhosync/console/app/routes/timing.rb",
    "lib/rhosync/console/app/routes/user.rb",
    "lib/rhosync/console/app/views/client.erb",
    "lib/rhosync/console/app/views/content.erb",
    ...
    "lib/rhosync/console/app/views/rightboxlinks.erb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<log4r>, ["~> 1.1.7"])
